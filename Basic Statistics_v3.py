...
education = pd.read_csv(r"E:\Data Science 18012022\Data Sets\education.csv")
...
education.gmat.var() # variance
education.gmat.std() # standard deviation
...
data = pd.read_csv(r"E:/Data Science 18012022/Data Preprocessing/DataSets-Data Pre Processing/boston_data.csv")
data.dtypes
...
df = pd.read_csv("E:/Data Science 18012022/Data Sets/ethnic diversity.csv")
df.dtypes
...
df = pd.read_csv("E:/Data Science 18012022/Data Preprocessing/DataSets-Data Pre Processing/animal_category.csv")
...
d = pd.read_csv(r"E:/Data Science 18012022/Data Sets/mtcars.csv")
...
stats.t.ppf(0.025, 139) # Given probability, find the t value; # similar to qt in R
